package com.exnotis.backend.security.constants;
...
public class SecurityConstants {
    ...
    public static final String GET_ARRAYS_ADMINISTRATION = "exnotis.com";
    ...
    public static final String EXTOKEN = "ExToken";
    public static final String EXTOKEN_PREFIX = "ExToken ";
}
